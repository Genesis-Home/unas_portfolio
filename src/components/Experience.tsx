...
const experiences = [
  {
    ...
    glowColor:
      "border-blue-500/30 hover:border-blue-500/70 shadow-blue-500/5 hover:shadow-blue-500/15",
  ...
  },
  {
    ...
    glowColor:
      "border-violet-500/30 hover:border-violet-500/70 shadow-violet-500/5 hover:shadow-violet-500/15",
  ...
  },
  {
    ...
    glowColor:
      "border-emerald-500/30 hover:border-emerald-500/70 shadow-emerald-500/5 hover:shadow-emerald-500/15",
  ...
  },
  {
    ...
    glowColor:
      "border-slate-500/30 hover:border-slate-500/70 shadow-slate-500/5 hover:shadow-slate-500/15",
  ...
  },
  {
    ...
    glowColor:
      "border-amber-500/30 hover:border-amber-500/70 shadow-amber-500/5 hover:shadow-amber-500/15",
            ...
            >
              ...
              <div className="absolute -left-[16px] sm:-left-[30px] md:-left-[38px] top-7 z-20 flex items-center justify-center">
                <span className="relative flex h-5 w-5">
                  ...
                  <span
                    className={`relative inline-flex rounded-full h-5 w-5 border border-white/10 ${exp.color}`}
                  ></span>
                </span>
              </div>
                    ...
                    {exp.achievements.map((item, i) => (
                      ...
                      >
                        <div className="mt-1">
                          <CheckSquare
                            size={13}
                            className="text-primary/45 group-hover/item:text-primary transition-colors shrink-0"
                          />
                        </div>
