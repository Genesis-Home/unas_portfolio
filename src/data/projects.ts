...
export const projectsList: Project[] = [
  ...
  },
  {
    ...
    description:
      "A multi-tier AI text humanization platform that transforms AI-generated content into natural, reader-engaging writing. Offers Lite, Pro, and Ultra processing models with built-in AI detection, rewriting, translation, citation checking, and a writing agent — all with free unlimited access.",
    metrics: [
      { label: "Processing Tiers", value: "3 Models" },
      { label: "Tool Suite", value: "6+ Modules" },
      { label: "Access Model", value: "Free / No Login" },
    ],
    tech: ["Next.js", "TypeScript", "OpenAI API", "Node.js", "PostgreSQL", "TailwindCSS"],
    glowColor: "rgba(99, 102, 241, 0.25)",
    glowGradient: "from-indigo-500/20 to-violet-500/20",
    iconName: "Cpu",
    url: "https://www.gpthumanizer.ai/",
    image: "/gpthumanizer.png",
    flow: [
      { node: "Text Ingress", note: "Editor UI" },
      { node: "AI Detection", note: "Classifier Model" },
      { node: "Humanizer Tier", note: "Lite / Pro / Ultra" },
      { node: "Style Engine", note: "Tone Adapter" },
      { node: "Output Delivery", note: "Streaming Response" },
    ],
  },
  {
    title: "Text to Song AI",
    category: "ai",
    subtitle: "Generative Music & Vocal Synthesis",
    detailedCategory: "AI Audio Generation Platform",
    description:
      "A browser-based generative music platform that turns text prompts and lyrics into fully produced songs with AI-synthesized vocals. Supports 40+ genre styles and 10+ languages with multi-track output (vocals, instruments, bass, percussion) and commercial licensing.",
    metrics: [
      { label: "Genre Styles", value: "40+ Supported" },
      { label: "Languages", value: "10+ Voices" },
      { label: "Generation Time", value: "< 30s / Track" },
    ],
    tech: ["Next.js", "React", "Node.js", "AI Audio Models", "FFmpeg", "S3 CDN"],
    glowColor: "rgba(139, 92, 246, 0.25)",
    glowGradient: "from-violet-500/20 to-fuchsia-500/20",
    iconName: "Activity",
    ...
    flow: [
      ...
      { node: "Vocal Synth", note: "Neural Singing Voice" },
      { node: "Multi-Track Mix", note: "Stem Assembler" },
      { node: "Studio Export", note: "WAV / MP3 CDN" },
    ],
  },
  {
    title: "ZeroDrift",
    category: "ai",
    subtitle: "AI Compliance Firewall",
    detailedCategory: "Regtech AI Platform",
    description:
      "A real-time AI compliance firewall enforcing SEC, FINRA, and firm-specific policies across email, LinkedIn, web, documents, and AI-generated content. Catches violations before send via Compose, Guard, and Command modules built on SOC 2 certified infrastructure.",
    metrics: [
      { label: "Compliance Coverage", value: "SEC / FINRA" },
      { label: "Channel Support", value: "5+ Surfaces" },
      { label: "Security Standard", value: "SOC 2 Certified" },
    ],
    tech: ["Next.js", "TypeScript", "Node.js", "OpenAI API", "PostgreSQL", "Webhooks"],
    glowColor: "rgba(245, 158, 11, 0.25)",
    glowGradient: "from-amber-500/20 to-orange-500/20",
    iconName: "Cpu",
    ...
    flow: [
      ...
      { node: "Policy Tier", note: "SEC / FINRA Rules" },
      { node: "Audit Bus", note: "Command Console" },
      { node: "Integration API", note: "Multi-Channel Webhooks" },
    ],
  },
  {
    title: "Go Cloud Careers",
    category: "cloud",
    subtitle: "Elite Cloud Architect Career Academy",
    detailedCategory: "Cloud Education Platform",
    description:
      "A premier career preparation platform for cloud architects and tech leaders — delivers hybrid live instruction on AWS, Azure, and enterprise architecture with TOGAF, CXO training, and an interview-driven curriculum built on 25,000+ real interviews.",
    metrics: [
      { label: "Students Trained", value: "1,000s Global" },
      { label: "Interview Corpus", value: "25,000+ Data" },
      { label: "Industry Tenure", value: "20+ Years" },
    ],
    tech: ["WordPress", "AWS", "Azure", "PHP", "MySQL", "Stripe"],
    glowColor: "rgba(245, 158, 11, 0.25)",
    ...
    flow: [
      ...
      { node: "AWS / Azure Labs", note: "Hands-On Cloud" },
      { node: "Community Hub", note: "Slack Integration" },
      { node: "Career Pipeline", note: "Interview Engine" },
    ],
  },
  {
    title: "Sustainable Metal Cloud",
    category: "cloud",
    subtitle: "Energy-Efficient GPU Supercloud",
    detailedCategory: "AI Infrastructure Platform",
    description:
      "Singapore's most energy-efficient GPU cloud — co-designed with NVIDIA for AI training and inference workloads. Features liquid-cooled H100/H200/A100 clusters, NDR InfiniBand networking, and parallel NVMe storage at hyperscale.",
    metrics: [
      { label: "CO₂ Reduction", value: "↓ 48% Saved" },
      { label: "Cluster Scale", value: "32,000 GPUs" },
      { label: "Uptime SLA", value: "99.50% Guaranteed" },
    ],
    tech: ["NVIDIA HGX", "Kubernetes", "InfiniBand", "Weka Storage", "S3 API", "Terraform"],
    glowColor: "rgba(59, 130, 246, 0.25)",
    glowGradient: "from-blue-500/20 to-cyan-500/20",
    iconName: "Server",
    url: "https://smc.co/",
    ...
    flow: [
      ...
      { node: "Liquid Cooling", note: "Sustainable Datacenter" },
      { node: "Storage Layer", note: "Weka NVMe + S3" },
      { node: "Orchestration", note: "Kubernetes Scheduler" },
    ],
  },
  {
    title: "Cloud 7 Storage",
    category: "cloud",
    subtitle: "High-Speed Object Storage Platform",
    detailedCategory: "Cloud Storage Service",
    description:
      "A high-performance, secure cloud storage platform offering S3 and IAM API compatibility, multi-region replication, and zero egress fees up to 3x average monthly storage — built for teams that need vendor-lock-in-free, global object delivery.",
    metrics: [
      { label: "Uptime SLA", value: "99.99% Live" },
      { label: "Throughput", value: "Up to 8.8 Gbps" },
      { label: "Storage Scale", value: "500% Elastic" },
    ],
    tech: ["S3 API", "IAM Compatible", "Node.js", "Terraform", "CloudFront", "Webflow"],
    ...
    flow: [
      ...
      { node: "Multi-Region Sync", note: "Global Replication" },
      { node: "Delivery Tier", note: "No Egress Fees" },
      { node: "Monitoring", note: "Uptime Telemetry" },
    ],
  },
];
